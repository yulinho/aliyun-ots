    ...
    'tables' => array(
        array(
            ...
            'put_rows' => array(
                ...
                array(
                    'condition' => 'IGNORE',
                    'primary_key' => array('PK0' => 2, 'PK1' => 'Zhejiang'),
                    'attribute_columns' => array('attr1' => 'Chandler Bing', 'attr2' => 256),
                ),
            ),
            'update_rows' => array(
                array(                                                           // 第一行
                    'condition' => 'IGNORE',
                    'primary_key' => array('PK0' => 3, 'PK1' => 'Zhejiang'),
                    'attribute_columns_to_put' => array('attr1' => 'Chandler Bing', 'attr2' => 256),
                ),
                array(                                                           // 第二行
                    'condition' => 'IGNORE',
                    'primary_key' => array('PK0' => 4, 'PK1' => 'Jiangsu'),
            ...
            'delete_rows' => array(
                array(                                                           // 第一行
                    'condition' => 'IGNORE',
                    'primary_key' => array('PK0' => 5, 'PK1' => 'Zhejiang'),
                ),
                array(                                                           // 第二行
                    'condition' => 'IGNORE',
                    'primary_key' => array('PK0' => 6, 'PK1' => 'Jiangsu'),
                ),
            ),
        ),
    ),
